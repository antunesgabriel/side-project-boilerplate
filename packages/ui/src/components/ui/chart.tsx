...
function ChartContainer({
  ...
  // [&_.recharts-cartesian-axis-tick_text]:text-subheading-2xs
  ...
  return (
    <ChartContext.Provider value={{ config }}>
      <div
        ...
        data-chart={chartId}
        className={cn(
          "[&_.recharts-cartesian-axis-tick_text]:fill-text-soft-400 [&_.recharts-cartesian-axis-tick_text]:text-subheading-2xs [&_.recharts-cartesian-grid_line[stroke='#ccc']]:stroke-stroke-soft-200 [&_.recharts-curve.recharts-tooltip-cursor]:stroke-stroke-sub-300 [&_.recharts-polar-grid_[stroke='#ccc']]:stroke-stroke-sub-300 [&_.recharts-radial-bar-background-sector]:fill-stroke-soft-200 [&_.recharts-rectangle.recharts-tooltip-cursor]:fill-stroke-soft-200 [&_.recharts-reference-line_[stroke='#ccc']]:stroke-stroke-sub-300 flex aspect-video justify-center text-paragraph-xs [&_.recharts-dot[stroke='#fff']]:stroke-transparent [&_.recharts-layer]:outline-hidden [&_.recharts-sector]:outline-hidden [&_.recharts-sector[stroke='#fff']]:stroke-transparent [&_.recharts-surface]:overflow-visible",
          className
        )}
        {...props}
      >
        ...
        {payload.map((item, index) => {
          ...
          return (
            <div
              key={item.dataKey}
              className={cn(
                "[&>svg]:text-text-soft-400 flex w-full flex-wrap items-stretch gap-2 [&>svg]:h-2.5 [&>svg]:w-2.5",
      ...
      {payload.map((item) => {
        ...
        return (
          <div
            key={item.value}
            className={cn(
              "[&>svg]:text-text-soft-400 flex items-center gap-1.5 [&>svg]:h-3 [&>svg]:w-3"
            )}
          >

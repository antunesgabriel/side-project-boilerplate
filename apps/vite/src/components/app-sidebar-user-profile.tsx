...
const CustomVerifiedIconSVG = () => (
  <svg
    ...
    className="size-6 text-verified-base"
  >
    <path
          ...
          <Dropdown.Trigger asChild>
            ...
            >
              ...
              <div className="flex-1 space-y-1 text-left">
                ...
                <div className="text-paragraph-xs text-text-sub-600 truncate max-w-36">
                  {session.user.email}
                </div>
              </div>
          ...
          <Dropdown.Content align="center" side="right">
            <div className="flex gap-3 items-center p-2">
              ...
              <div className="flex-1">
                <div className="text-label-sm text-text-strong-950 max-w-36 truncate">
                  {session.user.name}
                </div>
                <div className="mt-1 text-paragraph-xs text-text-sub-600 max-w-36 truncate">
                  {session.user.email}
                </div>
              </div>
